...
load(fullfile(datapath, 'Workspace_pre_localization_ref_S2_updated.mat'));
%load(fullfile(datapath, 'Workspace_pre_localization_ref_S2.mat'),'u_original','v_original');
...
% Saving image
%exportgraphics(fig1, fullfile('E:\Compaction_localization_data\S2', 'Localization_S2.tiff'), 'Resolution', 600);
...
%Saving image
%exportgraphics(fig2, fullfile('E:\Compaction_localization_data\S2', 'Localization_S2_full.tiff'), 'Resolution', 600);
