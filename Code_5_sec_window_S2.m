...
load(fullfile(datapath, 'Workspace_5_sec_window_S2_updated.mat'));
%load(fullfile(datapath, 'Workspace_5_sec_window_S2.mat'),'u_original','v_original');
...
scatter(Time,H11_av.*10^2,'filled','MarkerFaceColor', classic_colors(2,:))
p=104; %Onset of localization
...
%saving image
%exportgraphics(fig, fullfile('E:\Compaction_localization_data\S2', '5_sec_window_S2.tiff'), 'Resolution', 600);
